...
Source0  : https://files.pythonhosted.org/packages/1c/03/e8620fd9a48fde3b6f3db552912ba903c14c319bd220e70aac9b12ec3f7d/azure-mgmt-netapp-0.14.0.zip
Summary  : Microsoft Azure NetApp Files Management Client Library for Python
Group    : Development/Tools
License  : MIT
Requires: azure-mgmt-netapp-python = %{version}-%{release}
Requires: azure-mgmt-netapp-python3 = %{version}-%{release}
...
%package python
Summary: python components for the azure-mgmt-netapp package.
Group: Default
Requires: azure-mgmt-netapp-python3 = %{version}-%{release}

%description python
python components for the azure-mgmt-netapp package.


%package python3
Summary: python3 components for the azure-mgmt-netapp package.
Group: Default
...
%description python3
python3 components for the azure-mgmt-netapp package.


%prep
%setup -q -n azure-mgmt-netapp-0.14.0
cd %{_builddir}/azure-mgmt-netapp-0.14.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608046986
